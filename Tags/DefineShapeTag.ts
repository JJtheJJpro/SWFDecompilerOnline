...
export default class DefineShapeTag implements ITag {
    ...
    public static ReadData(br: SWFBitReader): DefineShapeTag {
        ...
        return new DefineShapeTag(Buffer.from(data), size, retShapeId, retShapeBounds, retShapes)
    }
}