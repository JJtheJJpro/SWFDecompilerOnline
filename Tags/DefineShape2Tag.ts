...
export default class DefineShape2Tag implements ITag {
    ...
    public static ReadData(br: SWFBitReader): DefineShape2Tag {
        ...
        return new DefineShape2Tag(Buffer.from(data), size, retShapeId, retShapeBounds, retShapes)
    }
}