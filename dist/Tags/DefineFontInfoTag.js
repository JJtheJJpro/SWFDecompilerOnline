...
class DefineFontInfoTag {
    _size;
    _data;
    constructor(data, size, fontID, fontNameLen, fontName, ffSmallText, ffShiftJIS, ffANSI, ffItalic, ffBold, ffWideCodes, codeTable) {
        this._data = data;
        this._size = size;
        this.FontID = fontID;
    ...
    get TagCode() {
        return SWFTags_1.default.DefineFontInfo;
    }
    get Size() {
        return this._size;
    }
...
exports.default = DefineFontInfoTag;
//# sourceMappingURL=DefineFontInfoTag.js.map