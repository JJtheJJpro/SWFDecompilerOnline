...
class ShapeWithStyle {
    ...
    static ReadData(br) {
        ...
        let retShapeRecords = [];
        let read = ShapeRecord_1.default.ParseWithStyle(br, retFillStyles, retLineStyles, retNumBits, true);
        retShapeRecords.push(read);
        while (true) {
            let read = ShapeRecord_1.default.ParseWithStyle(br, retFillStyles, retLineStyles, retNumBits);
            retShapeRecords.push(read);
