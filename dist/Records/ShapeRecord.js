...
(function (ShapeRecord) {
    function ParseWithStyle(br, refFillStyles, refLineStyles, numBits, first = false) {
        ...
        if (toread[0]) {
            ...
            if (toread.some(x => x)) {
                return StyleChangeRecord_1.default.ReadDataForShapeWithStyle(br, refFillStyles, refLineStyles, numBits, first);
            }
            else {
    ...
    function Parse(br, numBits) {
        ...
        if (toread[0]) {
            ...
            if (toread.some(x => x)) {
                return StyleChangeRecord_1.default.ReadDataForShape(br, numBits);
            }
            else {
                return EndShapeRecord_1.default.ReadData(br);
            }
